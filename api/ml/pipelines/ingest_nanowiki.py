"""
Ingestion script for nanowiki RDF data.
Reads nanowiki_clean.csv and inserts into material_records and toxicity_records
...
INPUT_FILE = PROCESSED_DATA_DIR / "nanowiki_clean.csv"


def insert_nanowiki(df, session):
...
def main():
    ...
    try:
        ...
        print(f"Loaded {len(df)} net-new records from {INPUT_FILE.name}.")
        ...
        m_ins, t_ins, dup = insert_nanowiki(df, session)
    ...
    print("\n" + "="*80)
    print("NANOWIKI INGESTION COMPLETE")
    print("="*80)
